			...
			[
				...
				'default' => [
					[
						...
						'field_label' => esc_html__( 'Observações', 'elementor-pro' ),
						'label' => esc_html__( 'Observações', 'elementor-pro' ),
						'placeholder' => esc_html__( 'Observação a respeito do seu pedido', 'elementor-pro' ),
					],
				],
				'title_field' => '{{{ label }}}',
				'condition' => [
	...
	private function render_woocommerce_checkout_coupon_form() {
		...
		<div class="e-coupon-box">
			...
			<div class="e-coupon-anchor" style="display:none">
				<label class="e-coupon-anchor-description"><?php esc_html_e( 'Digite o seu cupom', 'elementor-pro' ); ?></label>
				<div class="form-row">
					<div class="coupon-container-grid">
						<div class="col coupon-col-1 ">
							<input type="text" name="coupon_code" class="input-text" placeholder="<?php esc_attr_e( 'Código do Cupom', 'elementor-pro' ); ?>" id="coupon_code" value="" />
						</div>
						<div class="col coupon-col-2">
							<button <?php $this->print_render_attribute_string( 'button_coupon' ); ?>><?php esc_html_e( 'Aplicar', 'elementor-pro' ); ?></button>
						</div>
					</div>
				</div>
				<div class="clear"></div>
