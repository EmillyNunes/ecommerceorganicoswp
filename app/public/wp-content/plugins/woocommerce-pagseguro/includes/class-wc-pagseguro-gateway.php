...
class WC_PagSeguro_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->order_button_text  = __( 'Finalizar Pagamento', 'woocommerce-pagseguro' );
			...
			if ( ! get_query_var( 'order-received' ) ) {
				...
				wp_localize_script(
					...
					array(
						...
						'invalid_card'       => __( 'Verifique o número do seu cartão', 'woocommerce-pagseguro' ),
						'invalid_expiry'     => __( 'Verifique a data de expiração do seu cartão', 'woocommerce-pagseguro' ),
						'expired_date'       => __( 'Verifique a data de expiração do seu cartão', 'woocommerce-pagseguro' ),
						'general_error'      => __( 'Não foi possível processar os dados do seu cartão de crédito no PagSeguro, tente novamente ou entre em contato conosco para obter assistência.', 'woocommerce-pagseguro' ),
						'empty_installments' => __( 'Seleciona o número de parcelas', 'woocommerce-pagseguro' ),
					)
				);
			}
		}
